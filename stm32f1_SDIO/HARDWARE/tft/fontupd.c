...
//	res = f_open (&filefont, (const TCHAR*)GBK16_SDUPD, FA_OPEN_EXISTING | FA_READ);	//不可以进行写操作
//	res = f_open (&filefont, "0:/SYSTEM/FONT/GBK16.fon", FA_OPEN_EXISTING | FA_READ);	//不可以进行写操作
	...
	{
//		memset(c_HanZibuff, 0, 32);	//先清除数组缓存
