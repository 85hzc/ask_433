...
//#define BLUE		0x01cf	//蓝色	
#define WHITH		0xffff	//白色
...
/* 显示字符、汉字相关API */
void LCD_Draw_Char(u16 x,u16 y,u8 ch,u8 mode);  //LCD指定位置显示一个字符函数
...
/* 显示数字有关API */
void LCD_Display_String_Num(u16 x,u16 y,u8 *ch,u8 sum);  //LCD显示一个数字串函数，显示位数字体随机设定
void LCD_Display_Array_No0(u16 x,u16 y,u32 arr,u8 sum,u8 mode);   //LCD显示数字，高位为0时不显示
void LCD_Display_Array_Yes0(u16 x,u16 y,u32 arr,u8 sum,u8 mode);  //LCD显示数字，高位为0时显示0
void LCD_Display_String_Num1(u16 x,u16 y,u8 *ch,u8 fontsize,u16 chlen,u16 sum,u16 charcolor,u16 bkcolor);	//LCD显示一个数字串函数，显示位数、字体、背景颜色随机设定
