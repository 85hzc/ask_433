...
#define SD_CARD					0	//外挂的SD卡
#define EX_FLASH				1	//外挂的flash

/**********************************************************
                       定义扇区缓存大小
**********************************************************/

#define FLASH_SECTOR_SIZE		512	//扇区大小为512byte

#define FLASH_BLOCK_SIZE		8	//每个快有8个扇区

u16 FLASH_SECTOR_COUNT=2048*6;	//6M字节
