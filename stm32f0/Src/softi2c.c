...
{
  return HAL_GPIO_ReadPin(GPIOB, I2C2_SDA_Pin);
}
...
void IIC_SDA_1()
{
  HAL_GPIO_WritePin(GPIOB, I2C2_SDA_Pin, 1);
}
...
void IIC_SDA_0()
{
  //GPIO_ResetBits(GPIOF, GPIO_Pin_7);
    ...
    HAL_GPIO_WritePin(GPIOB, I2C2_SDA_Pin, 0);
}
...
//GPIO_SetBits(GPIOF, GPIO_Pin_6);
    ...
    HAL_GPIO_WritePin(GPIOB, I2C2_SCL_Pin, 1);
}
...
//GPIO_ResetBits(GPIOF, GPIO_Pin_6);  
    HAL_GPIO_WritePin(GPIOB, I2C2_SCL_Pin, 0);
