...
void MBI_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(MBI_GCLK_PORT, GCLK_PIN, GPIO_PIN_SET);
    HAL_GPIO_WritePin(MBI_PORT, LE_PIN|SDI_PIN|DCLK_PIN, GPIO_PIN_SET);
    HAL_GPIO_WritePin(AG_PORT, AG_CLK_PIN|AG_DIN_PIN|AG_OE_PIN, GPIO_PIN_SET);
}
